...
const en = {
	...
	'cft.hero.server': 'This server',
	'cft.hero.edge': 'Cloudflare edge',
	'cft.hero.outbound': 'outbound only',
...
const id: Record<keyof typeof en, string> = {
	...
	'cft.hero.server': 'Server ini',
	'cft.hero.edge': 'Edge Cloudflare',
	'cft.hero.outbound': 'hanya koneksi keluar',
