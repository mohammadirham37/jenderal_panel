<script lang="ts">
	...
	const navItems = [
		...
		{ href: '/websites', label: 'Websites', icon: 'globe-alt' },
		{ href: '/server', label: 'Server', icon: 'server' },
		{ href: '/services', label: 'Services', icon: 'layers' },
		{ href: '/nginx', label: 'Nginx', icon: 'globe' },
		{ href: '/php', label: 'PHP', icon: 'code' },
		{ href: '/ssl', label: 'SSL', icon: 'lock' },
		{ href: '/deployments', label: 'Deploy', icon: 'upload' },
		{ href: '/cron', label: 'Cron', icon: 'clock' },
		{ href: '/queue-workers', label: 'Queue', icon: 'refresh' },
		{ href: '/nodejs', label: 'Node.js', icon: 'terminal' },
		{ href: '/databases', label: 'Databases', icon: 'database' },
		{ href: '/docker', label: 'Docker', icon: 'cube' },
